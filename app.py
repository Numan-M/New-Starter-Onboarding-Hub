...
def create_app(test_config=None):
    ...
    app.config['FEATURE_ADMIN_ENABLED'] = (
        os.getenv("FEATURE_ADMIN_ENABLED", "true").lower() == "true"
    )
    ...
    def inject_feature_flags():
        return {
            "FEATURE_ADMIN_ENABLED": app.config.get("FEATURE_ADMIN_ENABLED", True)
        }
    ...
    def general(section_name):
        return render_page(section_name)

    @app.route('/access/<tool>')
    @login_required
    def access(tool):
        return render_page(tool)
